...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        ...
        <div class="container mt-5 neomorphic-image-wrapper col-md-6">
            <div class="d-flex">
              <div class="col-md-12 m-2 text-center">
                <img class="align-middle" src="{{ asset('images/six-eleven-logo.png') }}" width="150" height="150">
                <h1 class="text-center">Welcome!</h1>
                <p class="display-4 text-center align-middle">This is the portal for SixEleven.</p>
              </div>
            </div>
        </div>
